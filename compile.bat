...
echo ========================================
echo FastConPTY Native Library Builder
echo ========================================

:: Configuration
set LIB_NAME=fastconpty
...
cl.exe /O2 /W3 /MD /EHsc /LD ^
   ...
   native\*.cpp ^
   user32.lib gdi32.lib shcore.lib advapi32.lib dwmapi.lib kernel32.lib ^
...
if %ERRORLEVEL% == 0 (
    ...
    :: Copy DLL to target/classes and src/main/resources for packaging
    if not exist src\main\resources mkdir src\main\resources
    copy /y build\%LIB_NAME%.dll src\main\resources\ >nul
    echo [SUCCESS] DLL copied to src\main\resources
) else (
    echo.
